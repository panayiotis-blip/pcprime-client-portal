-- =============================================================
-- Migration 055: smart_import RPC — add credentials support
-- Run this in Supabase Dashboard → SQL Editor → New Query
-- =============================================================
-- Replaces the smart_import RPC (migration 054) with a version that also
-- imports one platform credential per row into public.platform_credentials,
-- encrypting the password with the existing pgp_sym_encrypt helper.
--
-- Each row op may now include a "credential" object:
--   { "platform": "...", "username": "...", "password": "...", "notes": "..." }
-- A credential is inserted only when a platform or username is present.
-- =============================================================
