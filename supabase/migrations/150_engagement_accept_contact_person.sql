-- =============================================================
-- Migration 150: Accept-page RPC returns the client contact person
-- Run this in Supabase Dashboard → SQL Editor → New Query
-- =============================================================
-- The engagement letter is addressed to the company, but the salutation
-- ("Dear …") should name the contact person. The public accept page needs
-- the contact person for that, so the token RPC now returns it too.
-- Adding an OUT column changes the return type, so drop first, then recreate.
-- =============================================================
...
returns table (
  ...
  client_id_number text, client_contact_person text,
