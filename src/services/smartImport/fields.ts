...
export const IMPORT_FIELDS: ImportField[] = [
  ...
  { key: 'vat_start_month', label: 'VAT Starting Month (1-12)', group: 'Registrations',
    aliases: ['vat starting month', 'vat start month', 'vat period start'] },
  { key: 'oss_vat_start_month', label: 'OSS Starting Month (1-12)', group: 'Registrations',
    aliases: ['oss starting month', 'oss start month', 'oss period start'] },
